/* Rivalis · vendor.js
   Bibliotecas de terceiros, embutidas para o jogo não depender de CDN:
   PeerJS 1.5.4 (MIT) — conexão entre os aparelhos
   qrcode-generator 1.4.4 (MIT) — QR code da sala
...
}catch(e){console.warn("PeerJS indisponível:",e)}
try{
//---------------------------------------------------------------------
//
...
;window.qrcode=qrcode;}catch(e){console.warn("QR indisponível:",e)}
